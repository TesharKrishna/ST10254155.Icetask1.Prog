...
namespace ShoppingCartApp
    {
            ...
            public void RemoveProduct(Product product)
            {
                ...
                for (int i = 0; i < itemCount; i++)
                {
                    if (products[i] == product)
                    {
                        ...
                        itemCount--;
                        found = true;
                        Console.WriteLine($"Removed '{product.Name}' from the shopping cart.");
                        break;
                    }
                }
                if (!found)
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                Console.WriteLine($"Items in the cart: {cart.ItemCount}");
                ...
                Console.WriteLine($"Items in the cart after removal: {cart.ItemCount}");
